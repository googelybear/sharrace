package ch.sharrace.views.bookings;

import ch.sharrace.data.SamplePerson;
import ch.sharrace.services.SamplePersonService;
import ch.sharrace.views.MainLayout;
...
public class BookingsView extends Div implements BeforeEnterObserver {
    ...
    public BookingsView(SamplePersonService samplePersonService) {
